...
extern void sctp_locked_conn_add(struct inet_sk_info *);
extern void rst_unlock_tcp_connections(void);
extern void cpt_unlock_tcp_connections(void);
extern void rst_unlock_sctp_connections(void);
extern void cpt_unlock_sctp_connections(void);

extern int dump_one_tcp(int sk, struct inet_sk_desc *sd, SkOptsEntry *soe);
extern int dump_one_sctp(int sk, struct inet_sk_desc *sd);
extern int restore_one_tcp(int sk, struct inet_sk_info *si);
extern int restore_one_sctp(int sk, struct inet_sk_info *si);
